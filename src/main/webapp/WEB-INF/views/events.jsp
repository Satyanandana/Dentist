...
<div id="table">
 ...
 <div class="panel panel-info">
  ...
  <td>Closed</td>
   ...
   <form class="form-horizontal" name="appointmentRequestForm" id="appointmentRequestForm" class="appointmentRequestForm">
  <fieldset>
    
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Date</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" id="datepick" name="appointmentdate" placeholder="mm/dd/yyyy">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <textarea class="form-control" rows="3" id="note" name="note" placeholder="Max 250 words"></textarea>
  ...
  <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
   ...
   <div class="form-group">
      <div class="col-lg-10 col-lg-offset-2">
        ...
        <button  class="btn btn-primary" onclick="requestedappointments.sendRequestedAppointment('../appointmentrequests/create')">Book Appointment</button>
      </div>
    </div>
