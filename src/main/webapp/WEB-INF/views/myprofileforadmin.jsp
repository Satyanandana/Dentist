...
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/mustache.js'/>"></script>




<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/jquery.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/jquery.min.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/myprofilefunctions.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/myprofileready.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/ajax.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/changestatus.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/sentmessages.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/receivedmessages.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/confirmedappointments.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/requestedappointments.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/treatments.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/insurances.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/myprofile.js'/>"></script>

<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/teethTreatments.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/senddocuments.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/resources/js/adminjs/receiveddocuments.js'/>"></script>
<script type="text/javascript"
...
<body>
	...
	<div class="container" style="height: 75%; width: 95%;">
		...
		<br />
		<h1>My Dash Board for patient <p id="patientID">${requestScope.patientID}</p></h1>
		<br />
				...
				<div id="Messages">
					...
					<div class="col-sm-12"
						...
						<div class="list-group">
							...
							<h2>
								<i class="fa fa-reply"></i> Received Messages From Patient
							</h2>
							<br />
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary"
						onclick="sentmessages.sendMessage('../../sentmessages/sendtopatient/')">Send</button>
				</div>
			</div>
