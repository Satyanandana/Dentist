...
<td>
  <button  class="btn btn-primary btn-xs" id="appointmentsRequesedStatusChange" onclick="postRequestedAppointmentStatus({{appointmentRequestID}},{{patientID}},'{{note}}',this.value)"  style="visibility:{{hidden}};">Change Status</button>
...
<script type="text/template" id="mydocumentsTemp">
    ...
    <tr >
      ...
      <td><a href="../../doc/download/sent/{{docID}}/{{receiverID}}" target="_blank">View File</a></td>
...
<script type="text/template" id="receiveddocumentsTemp">
    ...
    <tr >
      ...
      <td><a href="../../doc/download/received/{{docID}}/{{senderID}}" target="_blank">View File</a></td>
