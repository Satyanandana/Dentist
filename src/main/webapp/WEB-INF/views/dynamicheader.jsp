								...
								<ul class="dropdown-menu dropdown-menu-default">
									<c:choose>
										<c:when test="${role == 'ROLE_USER'}">
											...
											<li><a
												href="<c:url  value="/profile/view?action=profile" />">
													<i class="fa fa-user"></i>&nbsp;&nbsp;My Profile
											</a></li>
											<li><a
												href="<c:url  value="/profile/view?action=messages" />">
													<i class="fa fa-envelope"></i>&nbsp;&nbsp;Messages
											</a></li>
											<li><a
												href="<c:url  value="/profile/view?action=appointments" />">
													<i class="fa fa-calendar"></i>&nbsp;&nbsp;Appointments
											</a></li>
											<li><a
												href="<c:url  value="/profile/view?action=treatments" />">
													<i class="fa fa-gavel"></i>&nbsp;&nbsp;Treatments
											</a></li>
											<li><a
												href="<c:url  value="/profile/view?action=insurance" />">
													<i class="fa fa-medkit"></i>&nbsp;&nbsp;Insurance
											</a></li>
											<li><a
												href="<c:url  value="/profile/view?action=documents" />">
													<i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;&nbsp;Documents
											</a></li>
											<li><a
												href="<c:url  value="/profile/view?action=settings" />">
