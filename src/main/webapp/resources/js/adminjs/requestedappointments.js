...
var requestedappointments = (function() {
	...
	var displayAppointments = function(data) {
		...
		if (jQuery.isEmptyObject(data)) {
			...
			$('#requestedAppointmentsForTemp')
					.append(
							"<tr><td style='border-style: ridge ;' colspan='5' align='center'>You Don't Have Any Requested Appointments . Yo can make one by clicking SCHEDULE NEW . </td></tr>");
		} else {
				...
				.ajax(
						{
							url : path
									...
									+ "/"
									+ $(
											'#updateRequestedAppointment #appointmentRequestID')
											.val(),
							method : 'POST',
