...
public class ServerSideValidations {
	...
	private static final String PASSWORD_PATTERN = "(?=.*[a-z])(?=.*[A-Z])(?=.*\\d).{6,10}"; // Atleast
																								// one
																								// upper
																								// case,one
																								// lower
																								...
																								// to
																								// 10
	private static final String NAME_PATTERN = "^[a-zA-Z]+$"; // Should contain
																// only
																// alphabets.
	...
	private static final String INCOME_PATTERN = "^([1-9]{1,3}([0-9]{3})*[0-9]{3}|[0-9]+)(.[0-9]{0,2})?$";// need
																											// check
	...
	public static boolean validatePassword(String password, Model model, Map<String, String> map, String errorName,
			String error) {
		Boolean valid = false;
	...
	public static boolean validateConfirmPassword(String password, String confirmpattern, Model model,
			Map<String, String> map, String errorName, String error) {
		Boolean valid = false;
	...
	public static boolean validateEmail(String email, Model model, Map<String, String> map, String errorName,
			String error) {
		Boolean valid = false;
	...
	public static boolean validateName(String name, Model model, Map<String, String> map, String errorName,
			String error) {
		boolean valid = false;
	...
	public static boolean validAddress(String address, Model model, Map<String, String> map, String errorName,
			String error) {
		boolean valid = false;
	...
	public static boolean validZipCode(String zipcode, Model model, Map<String, String> map, String errorName,
			String error) {
	...
	public static boolean validPhoneNumber(String phoneNumber, Model model, Map<String, String> map, String errorName,
			String error) {
		boolean valid = false;
	...
	public static boolean validEmployee(String employee, Model model, Map<String, String> map, String errorName,
			String error) {
		boolean valid = false;
	...
	public static boolean validateIncome(String income, Model model, Map<String, String> map, String errorName,
			String error) {
		boolean valid = false;
