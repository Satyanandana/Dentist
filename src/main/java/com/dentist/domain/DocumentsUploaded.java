...
@Scope("prototype")
@Entity
@Table(name = "documents_uploaded")
public class DocumentsUploaded implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DocumentsUploaded other = (DocumentsUploaded) obj;
